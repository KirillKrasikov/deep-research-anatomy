...
Разделы draft — только те, что прямо вытекают из запроса; не добавляй сопутствующие темы и общеобразовательный контекст.
Группируй маркеры по теме: один маркер = один подраздел или блок данных, а не отдельная цифра или ячейка таблицы.
